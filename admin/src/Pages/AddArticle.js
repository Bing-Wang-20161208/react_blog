...
function AddArticle(props) {
    ...
    const getTypeInfo = () => {
        axios({
            ...
            withCredentials: true   //跨域检验
        }).then(resp => {
            if (resp.data.data == '没有登陆') {
    ...
    const saveArticle = () => {
        ...
        let dateText = showDate.replace(/-/g, '/')   //字符串转换成时间戳
        dataProps.addTime = (new Date(dateText).getTime()) / 1000
        if (articleId === 0) {
            dataProps.view_account = 0
            axios({
                method: 'post',
                ...
                setArticleId(resp.data.insertId)
                ...
                <Col span={6}>
                    <Row>
                        <Col span={24}>
                            ...
                            <Button type="primary" size="large" onClick={saveArticle}>发布文章</Button><br/>
                        </Col>
                        <Col span={24}>
                            <br/>
                            <TextArea
